...
<template>
  <div>
    <!-- 注册框 -->
    <div>
      <el-drawer title="校园招聘系统" :visible.sync="showregister" :direction="direction" :before-close="handleClose1">
    ...
    <!-- 登录框 -->
    <div>
      <el-drawer title="校园招聘系统" :visible.sync="showlogin" :direction="direction" :before-close="handleClose">
          ...
          <div slot="header" style="margin-top: 20%">
            ...
            <el-form ref="form" :model="form" :rules="rules">
              ...
              <el-form-item inline-message>
                <el-row>
                  <el-col>
                    <el-button type="primary" @click.native.prevent="throttleLogin" style="width: 100%"
                      >登录
                    </el-button>
                  </el-col>
                  <el-col>
    ...
    <!-- 忘记密码 -->
    <div>
      <el-drawer title="校园招聘系统" :visible.sync="showfind" :direction="direction" :before-close="handleClose2">
        <el-card class="box-card" style="margin-top: 20%">
